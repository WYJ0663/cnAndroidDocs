 ...
 * 
 * SlidingDrawer 应该用于覆盖内部布局。这意味着SlidingDrawer应该只用于象 FrameLayout或
 * RelativeLayout 这样的布局的内部。SlidingDrawer 的大小定义了滑出屏幕时其占用的空间。
 * 因此一般SlidingDrawer 的长宽属性都设置为match_parent。 
 * 
